...
const CREATURE_DATA: Array[Dictionary] = [
	...
	{"path": LEGACY_ROOT + "1 (2).png", "name": "钢甲象", "traits": ["岩", "机械"], "range": "melee", "rarity": 0, "hp": 92, "damage": [8, 13], "cooldown": 4.8, "skill": "shield_self", "skill_name": "钢铁壁垒", "skill_text": "攻击后获得最大生命值 18% 的护盾"},
	...
	{"path": LEGACY_ROOT + "1 (4).png", "name": "岩甲龟", "traits": ["岩", "机械"], "range": "melee", "rarity": 0, "hp": 98, "damage": [7, 12], "cooldown": 5.0, "skill": "shield_self", "skill_name": "缩壳防御", "skill_text": "攻击后获得最大生命值 18% 的护盾"},
	...
	{"path": LEGACY_ROOT + "1 (6).png", "name": "冰角鹿", "traits": ["自然", "雷", "龙族"], "range": "ranged", "rarity": 0, "hp": 76, "damage": [10, 16], "cooldown": 4.0, "skill": "slow", "skill_name": "寒角冲击", "skill_text": "降低目标的技能充能"},
	...
	{"path": LEGACY_ROOT + "1 (8).png", "name": "深海贤者", "traits": ["雷", "龙族"], "range": "ranged", "rarity": 0, "hp": 74, "damage": [11, 16], "cooldown": 4.1, "skill": "team_charge", "skill_name": "潮汐启迪", "skill_text": "为其他友军补充技能充能"},
	...
	{"path": LEGACY_ROOT + "1 (10).png", "name": "烈焰犬", "traits": ["火", "龙族"], "range": "melee", "rarity": 1, "hp": 94, "damage": [14, 22], "cooldown": 3.8, "skill": "burn", "skill_name": "烈焰撕咬", "skill_text": "重击目标并附加额外燃烧"},
	...
	{"path": LEGACY_ROOT + "图层 3.png", "name": "铁壳蛛", "traits": ["岩", "虫群"], "range": "melee", "rarity": 1, "hp": 102, "damage": [10, 17], "cooldown": 4.6, "skill": "shield_self", "skill_name": "铁网甲壳", "skill_text": "攻击后获得最大生命值 18% 的护盾"},
	{"path": LEGACY_ROOT + "图层 4.png", "name": "星云兽", "traits": ["雷", "火", "机械"], "range": "ranged", "rarity": 2, "hp": 92, "damage": [18, 28], "cooldown": 3.4, "skill": "aoe", "skill_name": "星云爆发", "skill_text": "对所有敌人造成范围伤害"},
	{"path": LEGACY_ROOT + "图层 5.png", "name": "花甲虫", "traits": ["自然", "虫群"], "range": "melee", "rarity": 2, "hp": 118, "damage": [15, 23], "cooldown": 3.7, "skill": "team_charge", "skill_name": "虫群号令", "skill_text": "攻击并为其他友军补充技能充能"},
	{"path": LEGACY_ROOT + "图层 6.png", "name": "熔岩蛛", "traits": ["火", "岩", "虫群"], "range": "ranged", "rarity": 2, "hp": 108, "damage": [17, 26], "cooldown": 3.6, "skill": "aoe_burn", "skill_name": "熔岩喷发", "skill_text": "灼烧所有敌人并造成范围伤害"},

	{"path": NEW_ROOT + "1 (1).png", "name": "森冠鹿", "traits": ["自然", "植物"], "range": "ranged", "rarity": 2, "hp": 126, "damage": [17, 26], "cooldown": 3.8, "skill": "heal_ally", "skill_name": "森林恩泽", "skill_text": "重击目标并治疗生命比例最低的友军"},
	{"path": NEW_ROOT + "1 (2).png", "name": "花芽鹿", "traits": ["自然", "植物"], "range": "ranged", "rarity": 1, "hp": 88, "damage": [12, 19], "cooldown": 3.9, "skill": "team_charge", "skill_name": "花芽共鸣", "skill_text": "为其他友军补充技能充能"},
	...
	{"path": NEW_ROOT + "1 (4).png", "name": "潮汐王", "traits": ["雷", "龙族"], "range": "ranged", "rarity": 2, "hp": 120, "damage": [18, 29], "cooldown": 3.5, "skill": "aoe", "skill_name": "王者海啸", "skill_text": "对所有敌人造成范围伤害"},
	{"path": NEW_ROOT + "1 (5).png", "name": "潮汐卫", "traits": ["雷", "龙族"], "range": "ranged", "rarity": 1, "hp": 94, "damage": [13, 21], "cooldown": 3.8, "skill": "team_charge", "skill_name": "潮流号令", "skill_text": "为其他友军补充技能充能"},
	...
	{"path": NEW_ROOT + "1 (8).png", "name": "炽焰狼王", "traits": ["火", "龙族"], "range": "melee", "rarity": 2, "hp": 138, "damage": [20, 31], "cooldown": 3.4, "skill": "aoe_burn", "skill_name": "炼狱咆哮", "skill_text": "灼烧所有敌人并造成范围伤害"},
	{"path": NEW_ROOT + "1 (9).png", "name": "炎鬃狼", "traits": ["火", "龙族"], "range": "melee", "rarity": 1, "hp": 104, "damage": [15, 23], "cooldown": 3.6, "skill": "burn", "skill_name": "炎牙", "skill_text": "重击目标并附加额外燃烧"},
	{"path": NEW_ROOT + "1 (10).png", "name": "赤尾狐", "traits": ["火", "植物"], "range": "ranged", "rarity": 1, "hp": 86, "damage": [14, 22], "cooldown": 3.5, "skill": "double_hit", "skill_name": "狐火连击", "skill_text": "对目标追加一次 55% 伤害的攻击"},
	...
	{"path": NEW_ROOT + "1 (13).png", "name": "冰冠企鹅", "traits": ["雷", "机械"], "range": "ranged", "rarity": 1, "hp": 88, "damage": [13, 20], "cooldown": 3.7, "skill": "chain", "skill_name": "寒潮权杖", "skill_text": "攻击并跳跃至额外敌人"},
	{"path": NEW_ROOT + "1 (14).png", "name": "紫晶巨像", "traits": ["岩", "机械"], "range": "melee", "rarity": 2, "hp": 156, "damage": [18, 27], "cooldown": 4.2, "skill": "aoe", "skill_name": "晶核震荡", "skill_text": "对所有敌人造成范围伤害"},
	{"path": NEW_ROOT + "1 (15).png", "name": "苔岩守卫", "traits": ["岩", "植物"], "range": "melee", "rarity": 1, "hp": 124, "damage": [12, 19], "cooldown": 4.5, "skill": "shield_self", "skill_name": "苔岩壁垒", "skill_text": "攻击后获得最大生命值 18% 的护盾"},
	{"path": NEW_ROOT + "1 (16).png", "name": "小石怪", "traits": ["岩", "机械"], "range": "melee", "rarity": 0, "hp": 96, "damage": [8, 14], "cooldown": 4.8, "skill": "shield_self", "skill_name": "滚石护体", "skill_text": "攻击后获得最大生命值 18% 的护盾"},
	{"path": NEW_ROOT + "图层 3.png", "name": "苔心傀儡", "traits": ["自然", "机械"], "range": "ranged", "rarity": 1, "hp": 92, "damage": [12, 19], "cooldown": 4.0, "skill": "heal_ally", "skill_name": "苔心脉冲", "skill_text": "治疗生命比例最低的友军"},
	{"path": NEW_ROOT + "图层 4.png", "name": "晶背龟", "traits": ["岩", "虫群"], "range": "melee", "rarity": 1, "hp": 116, "damage": [12, 18], "cooldown": 4.4, "skill": "shield_self", "skill_name": "晶壳反射", "skill_text": "攻击后获得最大生命值 18% 的护盾"},
	{"path": NEW_ROOT + "图层 10.png", "name": "林角幼兽", "traits": ["自然", "龙族"], "range": "ranged", "rarity": 1, "hp": 90, "damage": [13, 20], "cooldown": 3.8, "skill": "seed_burst", "skill_name": "林风飞叶", "skill_text": "攻击目标并对另一名敌人造成溅射伤害"},
]
...
static func textures_for_rarity(rarity: int) -> Array[String]:
	var result: Array[String] = []
	for entry in CREATURE_DATA:
		if int(entry["rarity"]) == clampi(rarity, 0, 2):
			result.append(String(entry["path"]))
	return result
...
static func rarity_for_texture(texture_path: String) -> int:
	return clampi(int(data_for_texture(texture_path).get("rarity", 0)), 0, 2)
